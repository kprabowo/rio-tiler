...
class STACReader(
    ...
    include_asset_types: Set[str] = {'image/tiff', 'image/tiff; application=geotiff; profile=cloud-optimized', 'image/tiff; application=geotiff', 'application/x-hdf5', 'image/vnd.stac.geotiff; cloud-optimized=true', 'image/tiff; profile=cloud-optimized; application=geotiff', 'image/x.geotiff', 'image/jp2', 'application/x-hdf'},
